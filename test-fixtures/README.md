...
opens each in a downloaded VS Code with the released ObjectScript extension installed alongside, and
runs the suite in `src/test/suite` against two IRIS containers ([iris/docker-compose.yml](iris/docker-compose.yml)):
